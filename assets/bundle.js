...
},{"./PreactClasses/Matches":32,"preact":2}],13:[function(require,module,exports){
'use strict';
...
},{"./PreactClasses/MainLeagueApp":24,"preact":2}],14:[function(require,module,exports){
'use strict';
...
},{"./Champs/index.js":20,"./MatchUp/index.js":31,"preact":2}],15:[function(require,module,exports){
'use strict';
...
var StatsBlock = (_dec = (0, _preactRedux.connect)(function (store) {
    ...
    _createClass(StatsBlock, [{
            ...
            Array.from(this.props.activeVariables, function (variable) {
                ...
                if (variable.type === 'percent') {
                    cell = (0, _preact.h)(
                        'td',
                        null,
                        _this2.getPercentage(champ[variable.statName], champ.played)
                    );
                }
        ...
        value: function renderfirstChamps() {
            ...
            var firstChamps = this.statsClass.getFirstChamps();
            if (firstChamps) {
                var firstArray = [];
                Array.from(firstChamps, function (champ) {
...
},{"./methods/ChampFuncs":21,"./methods/Stats":23,"preact":2,"preact-redux":1}],18:[function(require,module,exports){
'use strict';
...
},{"./Patches":15,"./Regions":16,"./Variables":19,"./methods/Filters":22,"preact":2,"preact-redux":1}],19:[function(require,module,exports){
'use strict';
...
},{"preact":2,"preact-redux":1}],20:[function(require,module,exports){
'use strict';
...
},{"./StatsBlock":17,"./TopNav":18,"preact":2,"preact-redux":1}],21:[function(require,module,exports){
'use strict';
...
var Filters = function () {
    ...
    _createClass(Filters, [{
        ...
        value: function getVariables() {
            return [{ statName: 'fbTeam', friendlyName: 'First Blood Team', type: 'percent' }, { statName: 'fbKiller', friendlyName: 'First Blood Killer', type: 'percent' }, { statName: 'fbAssist', friendlyName: 'First Blood Assist', type: 'percent' }, { statName: 'firstDeath', friendlyName: 'First Death', type: 'percent' }, { statName: 'ftTeam', friendlyName: 'First Tower Team', type: 'percent' }, { statName: 'ftKiller', friendlyName: 'First Tower Killer', type: 'percent' }, { statName: 'fdTeam', friendlyName: 'First Dragon Team', type: 'percent' }, { statName: 'played', friendlyName: 'Games Played', type: 'value' }];
        }
    }, {
        key: 'getPatches',
...
var Stats = function () {
    ...
    _createClass(Stats, [{
        ...
        key: 'calculateFirstChamps',
        value: function calculateFirstChamps() {
            var _this = this;
        ...
        key: 'orderFirstChamps',
        value: function orderFirstChamps() {
            this.fbArray = [];
        ...
        key: 'addFirstStats',
        value: function addFirstStats(match) {
        ...
        key: 'gotFirst',
        value: function gotFirst(firstTeam, playerIndex) {
            return firstTeam === 0 && playerIndex < 5 || firstTeam === 1 && playerIndex > 4;
        }
    }, {
        key: 'getDefaultFirstStat',
        value: function getDefaultFirstStat() {
            return {
                played: 0,
                fbTeam: 0,
                ftTeam: 0,
...
},{"./AppMain":14,"./Matches":32,"./NavBar":34,"./reducers/store":40,"preact":2,"preact-redux":1,"redux":9}],25:[function(require,module,exports){
'use strict';
...
},{"./Players":27,"preact":2,"preact-redux":1}],26:[function(require,module,exports){
'use strict';
...
},{"./MatchCard":25,"preact":2,"preact-redux":1}],27:[function(require,module,exports){
'use strict';
...
},{"preact":2,"react-hint":4}],28:[function(require,module,exports){
'use strict';
...
},{"preact":2}],29:[function(require,module,exports){
"use strict";
...
},{"./StatCircle":28,"./StatsClass":29,"preact":2,"preact-redux":1}],31:[function(require,module,exports){
'use strict';
...
},{"./MatchElements":26,"./TeamStats":30,"preact":2,"preact-redux":1}],32:[function(require,module,exports){
'use strict';
...
var _MatchElement = require('./Matches/MatchElement');
...
},{"./Matches/MatchElement":33,"preact":2,"preact-redux":1}],33:[function(require,module,exports){
'use strict';
...
},{"preact":2}],35:[function(require,module,exports){
'use strict';
...
},{"./config":35,"./matches":37,"./regions":38,"./stats":39,"redux":9}],37:[function(require,module,exports){
'use strict';
...
},{"./index":36,"redux":9,"redux-logger":5,"redux-promise-middleware":6,"redux-thunk":8}],41:[function(require,module,exports){
'use strict';
