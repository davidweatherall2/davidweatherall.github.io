...
var MatchCard = function (_Component) {
	...
	function MatchCard() {
		...
		return _possibleConstructorReturn(this, (MatchCard.__proto__ || Object.getPrototypeOf(MatchCard)).apply(this, arguments));
	}
	...
	_createClass(MatchCard, [{
		...
		value: function renderAchievements(teamNum) {
			...
			var checks = ['firstBaron', 'firstBlood', 'firstDragon', 'firstInhibitor', 'firstTower'];
			var achievements = [];
			Array.from(checks, function (check) {
				if (_this2.props.game[check] == teamNum) {
		...
		value: function render() {
			return (0, _preact.h)(
				...
				(0, _preact.h)(
					'div',
					{ 'class': 'matches__card__date' },
					this.getTime(this.props.game.time)
				),
				(0, _preact.h)(
					'div',
					{ 'class': 'matches__columns  flex-align--center' },
					(0, _preact.h)(
						'div',
						{ 'class': 'matches__column  t-size--small' },
						this.renderAchievements(0)
					),
					(0, _preact.h)(
						'div',
						{ 'class': 'matches__column  flex  flex-justify--between' },
						(0, _preact.h)(
							'span',
							null,
					...
					(0, _preact.h)(
						'div',
						{ 'class': 'matches__column  t-align--right  t-size--small' },
			...
			if (team2) {
				Array.from(this.props.games, function (game) {
					if (game.teamNames.includes(team) && game.teamNames.includes(team2)) {
						cards.push((0, _preact.h)(_MatchCard2.default, { game: game }));
					}
				});
			} else {
				Array.from(this.props.games, function (game) {
