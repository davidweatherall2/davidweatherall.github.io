...
var MatchCard = function (_Component) {
	...
	_createClass(MatchCard, [{
		...
		value: function render() {
			return (0, _preact.h)(
				'div',
				{ className: 'matches__card  ' + this.getBackground() + '  ' + this.getBorder() },
				(0, _preact.h)(
					'div',
