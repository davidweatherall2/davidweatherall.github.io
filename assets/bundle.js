...
},{"./PreactClasses/Matches":23,"preact":2}],13:[function(require,module,exports){
'use strict';
...
},{"./FirstBlood/index.js":15,"./MatchUp/index.js":22,"preact":2}],15:[function(require,module,exports){
'use strict';
...
},{"./AppMain":14,"./Matches":23,"./NavBar":24,"./reducers/store":28,"preact":2,"redux":9}],17:[function(require,module,exports){
'use strict';
...
var MatchCard = (_dec = (0, _preactRedux.connect)(function (store) {
	...
	function MatchCard(props) {
		...
		var _this = _possibleConstructorReturn(this, (MatchCard.__proto__ || Object.getPrototypeOf(MatchCard)).call(this, props));

		if (_this.props.team) {
			_this.index = 0;
			_this.enemyIndex = 1;
			if (_this.props.game.teamNames[1] == _this.props.team) {
				_this.index = 1;
				_this.enemyIndex = 0;
			}
		} else {
		...
		_this.setState({ showPlayers: false });
	...
	_createClass(MatchCard, [{
		...
		value: function renderPlayers() {
			if (this.state.showPlayers) {
				console.log('showing');
				return (0, _preact.h)(_Players2.default, { game: this.props.game, index: this.index, activeRegion: this.props.activeRegion });
			}
			return '';
		}
	}, {
		...
		value: function render() {
			return (0, _preact.h)(
				'div',
				{ className: 'card  ' + this.getBackground() + '  ' + this.getBorder() },
				(0, _preact.h)(
					'div',
...
var StatsClass = function () {
	...
	_createClass(StatsClass, [{
		...
		value: function Dragon(team) {
			...
			var DragonString = String(Dragon) + '%';
			return DragonString;
		}
	}, {
		key: 'blueDragon',
...
var TeamStats = (_dec = (0, _preactRedux.connect)(function (store) {
	...
	_createClass(TeamStats, [{
		key: 'renderGeneralStats',
		value: function renderGeneralStats() {
			return (0, _preact.h)(
				'div',
				{ className: 'matches__columns' },
				(0, _preact.h)(
					...
					(0, _preact.h)(
						...
						this.props.team1,
						' First Blood: ',
						this.stats.FB(this.props.team1)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team1,
						' Red First Blood: ',
						this.stats.redFB(this.props.team1)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team1,
						' Blue First Blood: ',
						this.stats.blueFB(this.props.team1)
					),
					(0, _preact.h)('br', null),
					(0, _preact.h)(
						'div',
						...
						this.props.team2,
						' First Blood: ',
						this.stats.FB(this.props.team2)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team2,
						' Red First Blood: ',
						this.stats.redFB(this.props.team2)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team2,
						' Blue First Blood: ',
						this.stats.blueFB(this.props.team2)
					)
				),
				(0, _preact.h)(
					'div',
					...
					(0, _preact.h)(
						...
						this.props.team1,
						' First Dragon: ',
						this.stats.Dragon(this.props.team1)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team1,
						' Red First Dragon: ',
						this.stats.redDragon(this.props.team1)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team1,
						' Blue First Dragon: ',
						this.stats.blueDragon(this.props.team1)
					),
					(0, _preact.h)('br', null),
					(0, _preact.h)(
						'div',
						...
						this.props.team2,
						' First Dragon: ',
						this.stats.Dragon(this.props.team2)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team2,
						' Red First Dragon: ',
						this.stats.redDragon(this.props.team2)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team2,
						' Blue First Dragon: ',
						this.stats.blueDragon(this.props.team2)
					)
				),
				(0, _preact.h)(
					'div',
					...
					(0, _preact.h)(
						...
						this.props.team1,
						' First Tower: ',
						this.stats.Tower(this.props.team1)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team1,
						' Red First Tower: ',
						this.stats.redTower(this.props.team1)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team1,
						' Blue First Tower: ',
						this.stats.blueTower(this.props.team1)
					),
					(0, _preact.h)('br', null),
					(0, _preact.h)(
						'div',
						...
						this.props.team2,
						' First Tower: ',
						this.stats.Tower(this.props.team2)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team2,
						' Red First Tower: ',
						this.stats.redTower(this.props.team2)
					),
					(0, _preact.h)(
						'div',
						null,
						this.props.team2,
						' Blue First Tower: ',
						this.stats.blueTower(this.props.team2)
					)
				)
			);
		}
...
},{"./StatsClass":20,"preact":2,"preact-redux":1}],22:[function(require,module,exports){
'use strict';
...
},{"./MatchElements":18,"./TeamStats":21,"preact":2,"preact-redux":1}],23:[function(require,module,exports){
'use strict';
...
},{"preact":2}],24:[function(require,module,exports){
'use strict';
...
},{"./FirstBlood/index.js":15,"./MatchUp/index.js":22,"preact":2}],25:[function(require,module,exports){
'use strict';
...
},{"./config":25,"./regions":27,"redux":9}],27:[function(require,module,exports){
'use strict';
...
},{"./index":26,"redux":9,"redux-logger":5,"redux-promise-middleware":6,"redux-thunk":8}],29:[function(require,module,exports){
'use strict';
