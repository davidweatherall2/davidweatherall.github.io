...
},{"./PreactClasses/Matches":33,"preact":2}],13:[function(require,module,exports){
'use strict';
...
var StatsBlock = (_dec = (0, _preactRedux.connect)(function (store) {
    ...
    _createClass(StatsBlock, [{
        ...
        value: function renderfirstChamps() {
            ...
            var firstChamps = this.statsClass.getChamps();
            if (firstChamps) {
                var firstArray = [];
                Array.from(firstChamps, function (champ) {
                    if (_this3.props.minPlayed && _this3.props.minPlayed > champ.played) return;
...
},{"./AppMain":14,"./Matches":33,"./NavBar":35,"./reducers/store":41,"preact":2,"preact-redux":1,"redux":9}],26:[function(require,module,exports){
'use strict';
...
},{"./Matches/MatchElement":34,"preact":2,"preact-redux":1}],34:[function(require,module,exports){
'use strict';
...
},{"preact":2,"preact-redux":1}],35:[function(require,module,exports){
'use strict';
