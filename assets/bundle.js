...
var MatchCard = function (_Component) {
	...
	_createClass(MatchCard, [{
		...
		value: function render() {
			return (0, _preact.h)(
				'div',
				{ className: 'matches__card  ' + this.getBackground() },
				(0, _preact.h)(
					'div',
