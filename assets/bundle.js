...
},{"./PreactClasses/Matches":31,"preact":2}],13:[function(require,module,exports){
'use strict';
...
},{"./PreactClasses/MainLeagueApp":23,"preact":2}],14:[function(require,module,exports){
'use strict';
...
},{"./Champs/index.js":19,"./MatchUp/index.js":30,"preact":2}],15:[function(require,module,exports){
'use strict';
...
var StatsBlock = (_dec = (0, _preactRedux.connect)(function (store) {
    ...
    _createClass(StatsBlock, [{
        ...
        key: 'renderFBChamps',
        value: function renderFBChamps() {
            var _this2 = this;

            var FBChamps = this.statsClass.getFBChamps();
            if (FBChamps) {
                var FBArray = [];
                Array.from(FBChamps, function (champ) {
                    FBArray.push((0, _preact.h)(
                        'tr',
                        null,
                        (0, _preact.h)(
                            'td',
                        ...
                        (0, _preact.h)(
                            'td',
                            null,
                            _this2.getPercentage(champ.fbTeam, champ.played)
                        ),
                        (0, _preact.h)(
                            'td',
                            null,
                            _this2.getPercentage(champ.fbKiller, champ.played)
                        ),
                        (0, _preact.h)(
                            'td',
                            null,
                            _this2.getPercentage(champ.fbAssist, champ.played)
                        ),
                        (0, _preact.h)(
                            'td',
                            null,
                            _this2.getPercentage(champ.firstDeath, champ.played)
                        )
                    ));
                });
                return FBArray;
...
},{"./methods/ChampFuncs":20,"./methods/Stats":22,"preact":2,"preact-redux":1}],18:[function(require,module,exports){
'use strict';
...
},{"./Patches":15,"./Regions":16,"./methods/Filters":21,"preact":2,"preact-redux":1}],19:[function(require,module,exports){
'use strict';
...
var Champs = (_dec = (0, _preactRedux.connect)(function (store) {
	...
	function Champs(props) {
		...
		_this.regions = ['CBLOL', 'EULCS', 'LCK', 'NALCS'];
...
},{"./StatsBlock":17,"./TopNav":18,"preact":2,"preact-redux":1}],20:[function(require,module,exports){
'use strict';
...
var Stats = function () {
    ...
    _createClass(Stats, [{
        ...
        key: 'calculateFBChamps',
        value: function calculateFBChamps() {
            var _this = this;
        ...
        key: 'orderFBChamps',
        value: function orderFBChamps() {
            this.fbArray = [];
            for (var champId in this.fbChampsObject) {
                var champ = this.fbChampsObject[champId];
                champ['id'] = champId;
        ...
        key: 'sortFBByPercentage',
        value: function sortFBByPercentage(a, b) {
        ...
        key: 'addFBStats',
        value: function addFBStats(match) {
        ...
        key: 'gotFirstBlood',
        value: function gotFirstBlood(fbTeam, playerIndex) {
            return fbTeam === 0 && playerIndex < 5 || fbTeam === 1 && playerIndex > 4;
        }
    }, {
        key: 'getDefaultFBStat',
        value: function getDefaultFBStat() {
            return {
                played: 0,
                fbTeam: 0,
                fbKiller: 0,
...
},{"./AppMain":14,"./Matches":31,"./NavBar":33,"./reducers/store":39,"preact":2,"preact-redux":1,"redux":9}],24:[function(require,module,exports){
'use strict';
...
},{"./Players":26,"preact":2,"preact-redux":1}],25:[function(require,module,exports){
'use strict';
...
},{"./MatchCard":24,"preact":2,"preact-redux":1}],26:[function(require,module,exports){
'use strict';
...
},{"preact":2,"react-hint":4}],27:[function(require,module,exports){
'use strict';
...
},{"preact":2}],28:[function(require,module,exports){
"use strict";
...
},{"./StatCircle":27,"./StatsClass":28,"preact":2,"preact-redux":1}],30:[function(require,module,exports){
'use strict';
...
},{"./MatchElements":25,"./TeamStats":29,"preact":2,"preact-redux":1}],31:[function(require,module,exports){
'use strict';
...
},{"./Matches/MatchElement":32,"preact":2,"preact-redux":1}],32:[function(require,module,exports){
'use strict';
...
},{"preact":2,"preact-redux":1}],33:[function(require,module,exports){
'use strict';
...
},{"preact":2}],34:[function(require,module,exports){
'use strict';
...
},{"./config":34,"./matches":36,"./regions":37,"./stats":38,"redux":9}],36:[function(require,module,exports){
'use strict';
...
},{"./index":35,"redux":9,"redux-logger":5,"redux-promise-middleware":6,"redux-thunk":8}],40:[function(require,module,exports){
'use strict';
