...
},{"./PreactClasses/Matches":19,"preact":2}],12:[function(require,module,exports){
'use strict';
...
},{"./FirstBlood/index.js":14,"./MatchUp/index.js":18,"preact":2}],14:[function(require,module,exports){
'use strict';
...
},{"./AppMain":13,"./NavBar":20,"./reducers/store":24,"preact":2,"redux":8}],16:[function(require,module,exports){
'use strict';
...
var MatchCard = function (_Component) {
	...
	function MatchCard(props) {
		...
		_this.index = 0;
		_this.enemyIndex = 1;
		if (_this.props.team && _this.props.game.teamNames[1] == _this.props.team) {
			_this.index = 1;
			_this.enemyIndex = 0;
		}
		return _this;
	...
	_createClass(MatchCard, [{
		...
		value: function renderMatchup() {
			...
			var team1colour = 't-colour--blue';
			var team2colour = 't-colour--red';
			...
			if (team2) {
				Array.from(this.props.games, function (game) {
					if (game.teamNames.includes(team) && game.teamNames.includes(team2)) {
						cards.push((0, _preact.h)(_MatchCard2.default, { game: game, team: false }));
					}
				});
			} else {
				Array.from(this.props.games, function (game) {
					if (game.teamNames.includes(team)) {
						cards.push((0, _preact.h)(_MatchCard2.default, { game: game, team: team }));
					}
				});
			}
			return cards;
...
},{"./MatchCard":16,"preact":2}],18:[function(require,module,exports){
'use strict';
	...
	_createClass(MatchUp, [{
		...
		value: function renderMatchup() {
			if (this.props.team1 && this.props.team2) {
				return (0, _preact.h)(_MatchElements2.default, { team1: this.props.team1, team2: this.props.team2, games: this.props.regionData });
			} else {
				return (0, _preact.h)(
					'div',
					null,
...
},{"./MatchElements":17,"preact":2,"preact-redux":1}],19:[function(require,module,exports){
'use strict';
...
},{"preact":2}],20:[function(require,module,exports){
'use strict';
...
},{"./FirstBlood/index.js":14,"./MatchUp/index.js":18,"preact":2}],21:[function(require,module,exports){
'use strict';
...
},{"./config":21,"./regions":23,"redux":8}],23:[function(require,module,exports){
'use strict';
...
},{"./index":22,"redux":8,"redux-logger":4,"redux-promise-middleware":5,"redux-thunk":7}],25:[function(require,module,exports){
'use strict';
